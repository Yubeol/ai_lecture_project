...
export const DEFAULT_SCRIPT = {
  ...
  utterances: [
    ...
    },
    {
      ...
      note: '음수가 나오면 "그럼 이 숫자는 어디서 온 걸까"로 연결',
    },
    {
      text: '이 숫자가 실제로 어떻게 계산되는지 보여드리겠습니다',
      note: '★ 곱하고 더하는 과정이 그대로. AI가 지어낸 숫자가 아니라는 증거',
    },
    {
      text: '코사인 유사도는 공식으로 이렇게 정의됩니다',
      note: '분모가 1이 되는 이유 — 모델이 벡터를 길이 1로 맞춰 내보냄',
    },
    {
